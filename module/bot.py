...
class Bot:
    ...
    def __init__(self):
        ...
        self.gc: Union[GlobalConfig, None] = None  # 延迟初始化，在 _init_global_config 中设置
        self.root: list = []
    ...
    async def process_error_message(self, client: pyrogram.Client, message: pyrogram.types.Message) -> None:
        ...
        await self._commands.process_error_message(client, message, self.keyword_handler)
    ...
    async def check_download_range(
        ...
        return await ValidationHelper.check_download_range(start_id, end_id, client, message)
    ...
    async def get_download_link_from_bot(
        ...
        return await self._commands.get_download_link_from_bot(
    ...
    async def get_download_chat_link_from_bot(
        ...
        return await self._commands.get_download_chat_link_from_bot(
    ...
    async def get_forward_link_from_bot(
        ...
        return await self._commands.get_forward_link_from_bot(client, message)
    ...
    async def get_upload_link_from_bot(
        ...
        return await self._commands.get_upload_link_from_bot(
            client, message, self.user, self.bot, self.last_message,
            delete, save_directory, recursion, valid_link_cache
        )
    ...
    async def on_listen(
        ...
        return await self._commands.on_listen(client, message)
...
class KeyboardButton:
    ...
    async def toggle_forward_setting_button(
        ...
        await self._handler.handle_toggle_forward_setting(global_config.get('forward_type', {}))
    ...
    def toggle_download_chat_type_filter_button(
        ...
        return KeyboardManager.build_download_chat_dtype_filter_keyboard(download_chat_filter, chat_id)
